...
do
    ...
    /usr/bin/java -mx5g -cp "stanford-corenlp-4.0.0/*" edu.stanford.nlp.pipeline.StanfordCoreNLP -annotators tokenize,ssplit,pos,lemma,ner,parse -tokenize.whitespace true -file $FNAME -outputFormat xml
